...
# packages to install
ARCH_PACKAGES = lvm2 herbstluftwm fish openssh gnupg zsh dunst emacs opam rxvt-unicode xorg-server xorg-xinit xorg-twm xorg-xclock xterm udisks2 udiskie m4 ascii xclip picom dhcpcd dmenu borg wget xaw3d xorg-fonts-misc firefox 
